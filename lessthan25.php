...
<body style="background-color:rgb(229,229,229); font-family:Arial">
    <div style="float:left; width:25%;">
        ...
        <h2>Students with less than 25 marks.</h2>
        <hr>

        <?php 
            $con = mysqli_connect("localhost", "root", "", "stu_rec"); 
            $query = "SELECT * FROM Marks where cat1<25 or cat2<25";
            ...
            if ($result = mysqli_query($con, $query)) {
                ...
                echo '<h3>Number students who scored less than 25 in any subject are '.$num_rows.'</h3>';
